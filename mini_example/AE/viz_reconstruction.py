...
parser.add_argument('--model', type=str,
                    default='/media/zhao/inner_disk/cvpr19_code/checkpoint/shapenet_part_dataset_atlascaps_decoder_200.pth', help='model path')
...
#random selected capsules
hight_light_caps=[np.random.randint(0, opt.latent_caps_size) for r in range(10)]


test_dataset = shapenet_part_loader.PartDataset(root=opt.dataset_path, classification=True, class_choice="Airplane", npoints=opt.num_points, split='test')
